...
**This data is from... all data, prelim QC applied**
...
Most observations to date have been measured in units of percent saturation. In 2021, CMAR began deploying several sensors that record in concentration (mg / L) (@fig-do-n-obs-sat; see the Sensors section for more information).
