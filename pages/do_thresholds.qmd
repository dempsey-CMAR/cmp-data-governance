...
#| warning: false
#| fig-height: 4
#| fig-cap: Distribution of the 24-hour rolling standard deviation of dissolved oxygen (percent saturation) observations (binwidth = 0.25 %). Dotted orange line indicates rolling_sd_max.
