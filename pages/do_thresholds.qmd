...
#   mutate(
#     qc_flag = case_when(
#       dissolved_oxygen_percent_saturation < user_do$user_min ~ 3,
#       dissolved_oxygen_percent_saturation > user_do$user_max ~ 3,
#       TRUE ~ 1
#     )) %>%
#   qc_assign_flag_labels() %>%
#   ggplot() +
#   geom_histogram(aes(dissolved_oxygen_percent_saturation, fill = qc_flag), binwidth = 2) +
#   geom_vline(xintercept = user_do$user_min, linetype = 2, col = "orange")
# 
# ggplotly(p)
